...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function node_modulesRawLoaderDistCjsJsSrcAppAppComponentHtml(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "<h1>Ticket Booking App</h1>\r\n<app-booking></app-booking>";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /* harmony import */
    var _booking_booking_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__( /*! ./booking/booking.component */"./src/app/booking/booking.component.ts");
    /* harmony import */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _booking_booking_component__WEBPACK_IMPORTED_MODULE_4__["BookingComponent"]],
      ...
      _createClass(BookingComponent, [{
        ...
        value: function onSubmit() {
          ...
          if (this.userInput < 0 || this.userInput > 7 || !this.userInput) {
            ...
            var index = 0;
            var count = 0;
            this.coach.some(function (element) {
              index++;
              if (index % 7 === 0 && count < _this.userInput) {
                if (!element.isOccupied && count === _this.userInput - 1) {
                  count++;
                  if (count >= _this.userInput) {
                    return position = index - _this.userInput + 1;
                  }
                } else {
                  count = 0;
                }
            ...
            var bookingIndex = 1;
            var bookingCounter = this.userInput;
            if (position === undefined) {
              this.coach.forEach(function (element) {
                if (!element.isOccupied && bookingCounter !== 0) {
                  _this.ticket.push(element.seatNumber);
          ...
          (_this$bookedSeats = this.bookedSeats).push.apply(_this$bookedSeats, _toConsumableArray(this.ticket));
